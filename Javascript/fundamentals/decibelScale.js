...
//parameters: we receive "intensity" which represent the sound wave we need to find the loudness of.
//return: we must return a number that reprsent the loudness of a sound wave given it's intensity
//example: Test.assertEquals(Math.round(dBScale(Math.pow(10, -11))), 10);
